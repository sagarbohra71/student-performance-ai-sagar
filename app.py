...
# Demonstration dataset generated from study-related patterns.
...
st.write("Simple Random Forest demo for student performance prediction.")
...
with col1:
    ...
    student_class = st.selectbox(
        "Class",
        ["FY B.Com IT", "SY B.Com IT", "TY B.Com IT"]
    )
...
st.divider()
st.caption(
    "Educational prototype for poster presentation. "
    "Not for official academic decisions."
)
